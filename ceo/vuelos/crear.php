            ...
            <div class="card card-custom">
                ...
                <div class="card-body p-5">
                    ...
                    <form action="guardar.php" method="post">
                        ...
                        <div class="mb-3">
                            <label>Precio</label>
                            <input type="number" step="0.01" name="precio" class="form-control" min="0" max="5000000" required>
                        </div>

                        <div class="mb-3">
                            <label>Asientos Disponibles</label>
                            <input type="number" name="asientos" class="form-control" min="0" max="500" required>
                        </div>
